...
describe('callOperator', () => {
    ...
    it('updates displayValue to the difference of the storedValue and displayValue', () => {
        wrapper.setState({ storedValue: '3' })
        wrapper.setState({ displayValue: '2' })
        wrapper.setState({ selectedOperator: '-' })
        wrapper.instance().callOperator()
    ...
    it('updates displayValue to the product of the storedValue and the displayValue', () => {
        wrapper.setState({ storedValue: '3' })
        wrapper.setState({ displayValue: '2' })
    ...
    it('updates displayValue to the quotient of the storedValue and the displayValue', () => {
        wrapper.setState({ storedValue: '3' })
        wrapper.setState({ displayValue: '2' })
        wrapper.setState({ selectedOperator: '/' })
        wrapper.instance().callOperator()
