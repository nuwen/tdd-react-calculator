...
class Calculator extends Component {
    ...
    setOperator = value => {
        ...
        if (selectedOperator === '') {
            //update stored value to the value of displayValue
            ...
            // if selected operator is not an emptry string
            // update the value of the selected operator to the given value
            selectedOperator = value
        }
